              ...
              <div className="s4-bracket">
                  ...
                  return (
                    <div key={i} className={i === 0 ? "s4-s1" : "s4-s2"}>
                      <Tarjeta dia={`${labels.semiAbbr} · Semi ${i + 1}`} decidido={!!s.winner}>
                        <Fila byId={byId} fid={s.red} winner={s.winner} lado="rojo" bloqueada={!semiLista} onWin={() => marcarSemi(b.id, i, s.red)} onRemove={() => pedirReemplazo(b.id, i, "red", s.red)} />
                        <Fila byId={byId} fid={s.blue} winner={s.winner} lado="azul" bloqueada={!semiLista} onWin={() => marcarSemi(b.id, i, s.blue)} onRemove={() => pedirReemplazo(b.id, i, "blue", s.blue)} />
                      </Tarjeta>
                    </div>
                  );
                })}
                ...
                <div className="s4-final">
                  <Tarjeta dia={`${labels.finalAbbr} · Final`} decidido={!!campeon} destacada>
                    <Fila byId={byId} fid={finalistas[0]} winner={campeon} lado="rojo" onWin={() => marcarFinal(b.id, finalistas[0])} placeholder="Ganador Semi 1" bloqueada={!(finalistas[0] && finalistas[1])} />
                    <Fila byId={byId} fid={finalistas[1]} winner={campeon} lado="azul" onWin={() => marcarFinal(b.id, finalistas[1])} placeholder="Ganador Semi 2" bloqueada={!(finalistas[0] && finalistas[1])} />
                  </Tarjeta>
                </div>
              </div>
